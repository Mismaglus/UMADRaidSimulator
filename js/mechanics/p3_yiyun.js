...
SIM.register(P3_DEEPPAIN); SIM.register(P3_BOLT); SIM.register(P3_FIRE); SIM.register(P3_WATER); SIM.register(P3_LONG); SIM.register(P3_LAT); SIM.register(P3_WIND); SIM.register(P3_VACUUM); SIM.register(P3_SHOCKWAVE); SIM.register(P3_UMBRAL);
